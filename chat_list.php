...
<body>
    <div class="container">
            ...
            <div class = "text-center" style = "padding-bottom:30px; <?php if (ua_smt() == true) {
    ?>margin-top:30px;<?php
} ?>">
                <a href="chat_search.php" class="btn btn-primary btn-lg">グループ検索はこちら</a><?php if (ua_smt() == true) {
        ?><br/><br/><?php
    } ?>
            ...
            <div class ="col-xs-12">
                <div class="panel panel-default kadomaru">
                    <div class="panel-heading uekadomaru">
                        ...
                        <h3 class="panel-title text-center" style = "font-size:16px"><span style="color:red;"><?= $Row['count( roomid )']; ?></span>/<?php if ($Row2['limit'] == $Row['count( roomid )']) {
                ?>
